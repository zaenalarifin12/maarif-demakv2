...
@section('title', "Forum KKM")
  
@section('heading', "Forum KKM")

@section('breadcump')
    <li class="breadcrumb-item"><a href="{{ url("admin") }}">Dashboard</a></li>
    <li class="breadcrumb-item active" aria-current="page">Forum KKM</li>
@endsection
                            ...
                            <ul>
                                @if (Auth::user()->checkIsAdmin() )
                                    ...
                                    @foreach ($lembaga as $item)
                                        <li>
                                            <a href="{{ url("admin/forum-kkm/lembaga/$item->id/mata-pelajaran") }}" class="font-weight-bold text-info">{{$item->nama}}</a>
                                        </li>
