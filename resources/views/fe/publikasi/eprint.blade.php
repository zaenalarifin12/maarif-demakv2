                        ...
                        <div class="page-header">
                            ...
                            @forelse ($eprint as $item)
                                ...
                                <div class="items-row row-0 row clearfix">
                                    ...
                                    <div class="col-sm-2">
                                        <article class="item column-1" style="margin-bottom: 0px !important; margin-top: 0px !important">
                                        ...
                                        <article class="item column-1" style="margin-bottom: 0px !important; margin-top: 0px !important">
                                            ...
                                            <div class="entry-header has-post-format" >
                                                ...
                                                <h2>
                                                    ...
                                                    href="{{ asset("/files/siswa/$item->banner") }}">
                                                        {{ $item->judul }}</a>
                                                ...
                                                <dl class="article-info">
                                                    ...
                                                    <a href="{{ asset("/files/siswa/$item->banner") }}" 
